...
import { ResourceTypes } from '../models/resources.model';
...
export interface IOpenerService {
     ...
     */
    openReference(base: string, target: string): Promise<void>;
}
...
export class OpenerService implements IOpenerService {
    ...
    async openReference(base: string, target: string): Promise<void> {
        try {
            ...
            await this.editor.open(reference);
        } catch (error) {
