...
describe('Filters', () => {
    ...
    it('should canBeLoaded filters works', () => {
        ...
        expect(filters.canBeLoaded({...FILE, path: 'test.pltp', write: false })).toBeTruthy();
        expect(filters.canBeLoaded({...FILE, path: 'test.pltp', write: false, read: true })).toBeTruthy();
    ...
    it('should canBeReloaded filters works', () => {
        ...
        expect(filters.canBeReloaded({...FILE, path: 'test.pltp', write: false })).toBeTruthy();
        expect(filters.canBeReloaded({...FILE, path: 'test.pltp', write: false, read: true })).toBeTruthy();
