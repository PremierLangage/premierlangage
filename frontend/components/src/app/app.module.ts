...
import { RevaelViwerComponent, RevaelViwerComponentDefinition } from './components/reveal-viewer/reveal-viewer.component';
...
@NgModule({
  ...
  providers: [
    ...
    { provide: COMPONENT_DEFINITIONS, multi: true, useClass: RevaelViwerComponentDefinition }
  ],
})
