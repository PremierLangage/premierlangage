...
class ExceptionsTestCase(TestCase):
    ...
    def test_syntax_error_pl_init(self):
        ...
        classe = SyntaxErrorPL(path, line, lineno, message)
        ...
        classe2 = SyntaxErrorPL(path, line, lineno)
    ...
    def test_syntax_error_pl_str(self):
        ...
        str_message = abspath(path) + " - " + message + " at line " + lineno + ":\n" + line
    ...
    def test_semantic_error_init(self):
        ...
        classe = SemanticError(path, line, lineno, message)
        ...
        classe2 = SemanticError(path, line, lineno)
