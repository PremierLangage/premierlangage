...
class ModelTestCase(TestCase):
    ...
    def setUpTestData(self):
        ...
        self.user2 = User.objects.create_user(username='user1', password='12345')
        self.user3 = User.objects.create_user(username='user2', password='12345')
        self.user4 = User.objects.create_user(username='user3', password='12345')
        self.user5 = User.objects.create_user(username='user4', password='12345')
        self.user6 = User.objects.create_user(username='user5', password='12345')
    ...
    def test_QAAnswer(self):
        ...
        self.assertEqual(qaa.user.profile.rep, point - (reputation["ANSWER_ACCEPTED"] + reputation["CREATE_ANSWER"]))
    ...
    def test_QAQuestionVote(self):
        ...
        qaq2 = QAQuestion.objects.create( title="tests_qaq",user=self.user4, points=10, popularity=1)
    ...
    def test_QAQuestionComment(self):
        ...
        point2 = usertmp.profile.rep
        qaqcomment.save()
        self.assertEqual(qaqcomment.user.profile.rep,  point2 + reputation["CREATE_QUESTION_COMMENT"])
