...
<img alt="Exemple numérique" src="{% static 'documentation/images/exemple_numérical.png' %}" title="Exemple Numérique" /> 
...
<img alt="Exemple QCM" src="{% static 'documentation/images/exemple_PL.png' %}" title="Exemple QCM" /> 
