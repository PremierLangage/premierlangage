...
class ExoTestCase(TestCase):
    ...
    def test_bad_patch_question(self):
        ...
        self.assertContains(response, "Question with ID &#39;14585&#39; does not exists",
                            status_code=404)
    ...
    def test_bad_patch_answer(self):
        ...
        self.assertEqual(response.status_code, 404)
        self.assertContains(response, "Answer with ID &#39;14585&#39; does not exists",
                            status_code=404)
    ...
    def test_bad_patch_question_comment(self):
        ...
        self.assertEqual(response.status_code, 404)
        self.assertContains(response, "Comment with ID &#39;14585&#39; does not exists",
                            status_code=404)
