...
module.exports = ".editor-host {\n  position: relative;\n  padding: 0;\n  margin: 0;\n  display: flex;\n  flex-flow: column;\n  height: calc(100vh - 64px);\n  color: #5a5a5a; }\n\n.editor__container {\n  display: flex;\n  position: relative;\n  overflow: hidden;\n  height: 100%;\n  flex: 1; }\n\n.tab-bar {\n  z-index: 1;\n  display: flex;\n  position: relative;\n  height: 36px;\n  align-items: center;\n  overflow-x: auto;\n  overflow-y: hidden;\n  background-color: #F5F5F5; }\n\n.tab-item {\n  display: inline-flex;\n  height: 100%;\n  align-items: center;\n  position: relative;\n  font-size: 14px;\n  color: #5a5a5a;\n  font-style: normal;\n  padding: 0px 12px;\n  cursor: pointer; }\n\n.editor__workspace-area {\n  position: relative;\n  height: 100%; }\n\n.editor__workspace-area .workspace {\n    height: 100%; }\n\n.editor__workspace-area .workspace .workspace__editor {\n      height: calc(100% - 36px); }\n\n.editor__workspace-area .tab-bar .item-group {\n    display: flex;\n    align-items: center;\n    height: 100%;\n    width: 100%; }\n\n.editor__workspace-area .tab-item {\n    background-color: #ecedf0; }\n\n.editor__workspace-area .tab-item.active {\n      background-color: #FFF; }\n\n.editor__workspace-area .tab-item .tab-icon {\n      margin-right: 4px; }\n\n.editor__workspace-area .tab-item .tab-close {\n      font-size: 18px; }\n\n.editor__workspace-area .tab-item .tab-close:hover {\n        opacity: 1; }\n\n.editor__workspace-area .tab-item.changed {\n      border-bottom: 1px solid salmon; }\n\n.editor__workspace-area .code-editor, .editor__workspace-area .preview-editor, .editor__workspace-area .image-editor {\n    height: calc(100%); }\n\n.editor__workspace-area .image-editor {\n    background-color: #fff;\n    background-size: 100% 1.2em;\n    background-image: linear-gradient(0deg, transparent 79px, #abced4 79px, #abced4 81px, transparent 81px), linear-gradient(#eee 0.05em, transparent 0.05em); }\n\n.editor__workspace-area .image-editor img {\n      margin: auto;\n      position: absolute;\n      top: 0;\n      left: 0;\n      bottom: 0;\n      right: 0; }\n\n.editor__workspace-area .image-editor .code-editor__btn-group {\n      position: absolute;\n      top: 48px;\n      right: 12px;\n      width: 32px; }\n\n.editor__workspace-area .image-editor .code-editor__btn {\n      background-color: #ecedf0;\n      width: 32px;\n      height: 32px;\n      border-radius: 2px 4px;\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      cursor: zoom-in;\n      margin-bottom: 8px; }\n\n.editor__workspace-area .preview-editor {\n    overflow: auto; }\n\n.editor__workspace-area .preview-editor .preview-editor__content {\n      width: 100%;\n      height: 100%;\n      overflow: auto;\n      padding: 0 12px; }\n\n.sidebar-panel {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  background-color: #ecedf0;\n  overflow: hidden; }\n\n.sidebar-panel .tab-bar {\n    font-size: 1rem;\n    padding: 0 0 0 16px; }\n\n.sidebar-panel .sidebar-panel__content {\n    position: relative;\n    margin-top: 8px;\n    overflow-y: auto;\n    margin: 0;\n    height: calc(100% - 36px); }\n\n.spacer {\n  flex-grow: 1; }\n\n.editor-home {\n  text-align: center;\n  padding: 5rem 3rem; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
